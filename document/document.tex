  ...
  \subsection{Survey of existing tracking technologies}
    ...
    \begin{table}[h]
      ...
      IMU-based & \(3\) & \(4\) & \(3\) & \(5\) & \(15\) \\
       & Approximately \(100\text{ hours}\) for drift correction & £\(50-\text{£}60\) & \(2.8 \degree\) \cite{ref:imuerror} & <1 ms \cite{ref:imudatasheet} & \\
      \midrule
      ...
      \midrule
      Marker tracking via computer vision & 2 & 2 & 5 & 4 & 13 \\
