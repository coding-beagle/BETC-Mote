  ...
  \subsection{Survey of existing tracking technologies}
    ...
    \begin{table}[h]
      ...
      IMU-based & \(3\) & \(4\) & \(3\) & \(5\) & \(15\) \\
       & Approximately \(100\text{ hours}\) for drift correction, PCB design + sensor fusion & £\(50-\text{£}60\) & \(2.8 \degree\) \cite{ref:imuerror} & <1 ms \cite{ref:imudatasheet} & \\
      \midrule
      Pose estimation via computer vision & \(5\) & \(5\) & \(3\) & \(5\) & \(18\) \\
       & Existing solutions & £\(30\) USB Camera & \(10\degree-15\degree\) \cite{ref:cverror} & \(\le 100 \text{ ms}\) \cite{ref:cvlatency} & \\
      \midrule
      Flex Sensors & 3 & 4 & 3 & 5 & 15 \\
       & Moderate fab & £40-60 & 10-15° error & <100ms & \\
      \midrule
      AHRS & 3 & 3 & 4 & 4 & 14 \\
       & Moderate setup & £80-120 & 5-10° error & 100-200ms & \\
      \midrule
      Marker tracking via computer vision & \(4\) & \(3\) & \(5\) & \(5\) & \(17\) \\
       & Very complex & £150+ & <5° error & 100-200ms & \\
      \bottomrule
      \end{tabular}
    ...
    Analysis of existing methods shows that the two computer vision approaches score the same in terms of viability, therefore further analysis will be required to confirm the viability of each method.
...
\section{Methods} \label{sec:methods}
  ...
  \subsection{Comparison of both computer vision methods}
    ...
    Upon analysis of the RMSE, it was found that this value was \(25.4 \degree\). % TODO CALCULATE VALUE %
    ...
    \begin{figure}[h!]
      ...
      \caption{Top view of inferred 3D joint positions.}
